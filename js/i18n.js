...
const TRANSLATIONS = {
  ...
  es: {
    ...
    "cat.lead2":               "Estancias Vaguba nació para quienes llegan a México con maleta, sin saber bien por cuánto tiempo. Nómadas digitales, expatriados, médicos en residencia, profesionales en reubicación — gente que necesita un lugar real donde vivir, no un cuarto de hotel ni un contrato anual. Cada propiedad está completamente amueblada, lista para entrar, con WiFi de alta velocidad y atención directa sin intermediarios. Reservas directo con nosotros, sin comisiones de plataforma.",
    ...
    "pv.intro.eyebrow":  "— Col. Primavera, Puerto Vallarta",
    "pv.intro.titulo":   "Casa Heidi",
    "pv.intro.intro":    "En la Colonia Primavera de Puerto Vallarta, a solo 15 minutos del centro histórico y del malecón, Casa Heidi nació de una idea simple: tomar una casa familiar completa y convertirla en estudios amueblados independientes para que cada huésped tenga su propio espacio, su propia puerta, y la libertad de sentirse en casa — no en un cuarto de hotel.",
    "pv.intro.estudios_t": "Los estudios",
    "pv.intro.estudios": "Cada estudio de Casa Heidi tiene acceso privado con puerta directa a la calle, está completamente amueblado y equipado para estadías cortas y largas en Puerto Vallarta. La Colonia Primavera es una de las zonas más tranquilas de la ciudad: sin ruido urbano, sin tráfico pesado, sin aglomeraciones — una colonia residencial donde la gente trabaja, vive y descansa. El ritmo que necesitas para disfrutar Puerto Vallarta a tu manera. En planta baja del conjunto encontrarás un local con ropa, juguetes y accesorios deportivos de marcas americanas.",
    "pv.intro.pronto_t": "Próximamente en Casa Heidi",
    "pv.intro.pronto":   "Seguimos creciendo: tres estudios adicionales y una cafetería se suman pronto al conjunto para hacer de Casa Heidi un pequeño rincón con todo lo que necesitas a pasos de tu puerta.",
  ...
  en: {
    ...
    "cat.lead2":               "Estancias Vaguba was built for people who arrive in Mexico with a suitcase and an open timeline. Digital nomads, expats, medical residents, professionals on the move — people who need a real home, not a hotel room or a year-long lease. Every property is fully furnished, move-in ready, with fast WiFi and direct support — no middlemen, no platform fees. Book straight with us.",
    ...
    "pv.intro.eyebrow":  "— Col. Primavera, Puerto Vallarta",
    "pv.intro.titulo":   "Casa Heidi",
    "pv.intro.intro":    "In the Colonia Primavera neighborhood of Puerto Vallarta, just 15 minutes from the historic center and the malecón, Casa Heidi was born from a simple idea: take a full family home and convert it into independent furnished studios so every guest has their own space, their own door, and the freedom to feel at home — not in a hotel room.",
    "pv.intro.estudios_t": "The studios",
    "pv.intro.estudios": "Every Casa Heidi studio has private access with a door straight to the street, fully furnished and equipped for short and long stays in Puerto Vallarta. Colonia Primavera is one of the quietest neighborhoods in the city: no urban noise, no heavy traffic, no crowds — a residential area where people work, live, and rest. The pace you need to enjoy Puerto Vallarta on your own terms. On the ground floor of the complex you'll find a local shop with clothing, toys, and sports accessories from American brands.",
    "pv.intro.pronto_t": "Coming soon to Casa Heidi",
    "pv.intro.pronto":   "We keep growing: three additional studios and a café will soon join the complex, making Casa Heidi a little corner with everything you need just steps from your door.",
